...
var message = " you are invited on dinner at 9'o clock, on 14th August at Air University cafe";
...
var message2 = " you are invited on dinner at 9'o clock, on 14th August at Air University cafe";
for (var i = 0; i < guestList.length; i++) {
    console.log("Hi Mr. " + guestList[i] + message2);
}
console.log(guestList);
console.log("We can invite only two peoples for dinner");
var message3 = " We are sorry but we can't invite you on dinner";
