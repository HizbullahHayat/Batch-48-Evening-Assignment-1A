var locations = ["Russia", "Brazil", "US", "Canada", "Iran", "KSA", "China"];
console.log(locations);
var sortedArray = locations.slice(); //a copy of origional array to save origional copy of array
var alphabatically = sortedArray.sort();
